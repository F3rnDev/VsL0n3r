...
class KeyBindMenu extends FlxSubState
{
    ...
    var keyText:Array<String> = ["LEFT", "DOWN", "UP", "RIGHT", "SPACE"];
    var keyName:Array<String> = ["LEFT", "DOWN", "UP", "RIGHT", "STAR POWER"];
    var defaultKeys:Array<String> = ["A", "S", "W", "D", "SPACE", "R"];
    ...
    function textUpdate(){
        ...
        var isArrowTxt:Array<String> = [" ARROW\n", ""];
        var keyInt:Int = 0;
        ...
        for(i in 0...keys.length){
            ...
            keyTextDisplay.text += textStart + keyName[i] + ": " + ((keys[i] != keyText[i]) ? (keys[i] + " / ") : "" ) + keyText[i] + isArrowTxt[keyInt];
    ...
    function save(){
        ...
        FlxG.save.data.spaceBind = keys[4];
    ...
    function changeItem(_amount:Int = 0)
    {
        ...
        if (curSelected > 4) //put to the max of keys ya want
            curSelected = 0;
        if (curSelected < 0)
            curSelected = 4;
    }
